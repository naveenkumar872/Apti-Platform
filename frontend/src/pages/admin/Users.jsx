        ...
        <div className="space-y-3">
          ...
          <div className="grid grid-cols-2 gap-3">
            ...
            <div>
              ...
              <select value={form.year} onChange={e => setForm(f => ({ ...f, year: Number(e.target.value) }))} className={selectCls}>
          ...
          <div>
            ...
            <select value={form.branch} onChange={e => setForm(f => ({ ...f, branch: e.target.value }))} className={selectCls}>
      ...
      <div className="relative bg-gradient-to-br from-violet-600 via-purple-600 to-indigo-600 px-6 pt-8 pb-7 md:px-10 overflow-hidden">
        ...
        <div className="relative flex items-start justify-between gap-4">
          <div>
            ...
            <h1 className="text-2xl md:text-[28px] font-semibold text-white tracking-tight">Users</h1>
            <p className="text-white/70 text-sm mt-1.5">Manage students and teachers on the platform</p>
          </div>
          <button
      ...
      <div className="flex-1 p-5 md:p-8">
        ...
        {showUserModal && (
          <UserModal
            ...
            onSave={u => { setUsers(p => [u, ...p]); setShowUserModal(false); }}
          />
        )}
